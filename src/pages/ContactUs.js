  ...
  return (
    <div className={styles.contactUs}>
      ...
      <div className={styles.contactUsWrapper}>
        <div className={styles.sendMassage}>Contact Us</div>
      </div>
      <div className={styles.sendMassageWrapper}>
      ...
      <img className={styles.contactUsChild} alt="" src="../vector-288.svg" />
      <img className={styles.contactUsItem} alt="" src="../vector-289.svg" />
      ...
      <div className={styles.contactUsChild4} />
      ...
      <img className={styles.groupIcon} alt="" src="../group-10000044034.svg" />
    </div>
  );
};
