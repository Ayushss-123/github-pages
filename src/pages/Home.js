  ...
  return (
    <div className={styles.home}>
      ...
      <div className={styles.allRightReservedContainer}>
        ...
        <p className={styles.allRightReserved}>ALL RIGHT RESERVED</p>
      </div>
      ...
      <img className={styles.arrowRightIcon5} alt="" src="../arrowright5.svg" />
      <img className={styles.arrowRightIcon6} alt="" src="../arrowright5.svg" />
      ...
      <img
        className={styles.homeChild4}
        alt=""
        src="../group-10000044031.svg"
      />
    </div>
  );
};
