...
const Portofolios = () => {
  return (
    <div className={styles.portofolios}>
      ...
      <img className={styles.portofoliosItem} alt="" src="../vector-288.svg" />
      <img className={styles.portofoliosInner} alt="" src="../vector-289.svg" />
      ...
      <img
        className={styles.portofoliosChild4}
        alt=""
        src="../ellipse-333.svg"
      />
      <img
        className={styles.portofoliosChild5}
        alt=""
        src="../ellipse-333.svg"
      />
      <img
        className={styles.portofoliosChild6}
        alt=""
        src="../ellipse-333.svg"
      />
      ...
      />
      <img className={styles.groupIcon} alt="" src="../group-1000004403.svg" />
    </div>
  );
};
