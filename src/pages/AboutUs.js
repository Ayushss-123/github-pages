...
const AboutUs = () => {
  return (
    <div className={styles.aboutUs}>
      ...
      <img className={styles.ellipseIcon} alt="" src="../ellipse-333.svg" />
      <img className={styles.aboutUsChild3} alt="" src="../ellipse-333.svg" />
      <img className={styles.aboutUsChild4} alt="" src="../ellipse-333.svg" />
      ...
      <img className={styles.aboutUsChild5} alt="" src="../vector-289.svg" />
      <div className={styles.groupDiv}>
        ...
        <div className={styles.enterYourEmailToGetTheLaParent}>
          ...
          <img className={styles.groupChild1} alt="" src="../ellipse-742.svg" />
        </div>
        <div className={styles.oneOfThe}>One of the best furniture agency.</div>
        <div className={styles.ellipseParent}>
          <img className={styles.groupChild2} alt="" src="../ellipse-320.svg" />
      ...
      />
      <img className={styles.groupIcon} alt="" src="../group-1000004404.svg" />
    </div>
  );
};
