...
const Sevices = () => {
  return (
    <div className={styles.sevices}>
      ...
      <img className={styles.sevicesItem} alt="" src="../vector-288.svg" />
      <img className={styles.sevicesInner} alt="" src="../vector-289.svg" />
      ...
      <img className={styles.arrowRightIcon1} alt="" src="../arrowright8.svg" />
      <img className={styles.arrowRightIcon2} alt="" src="../arrowright8.svg" />
      <img className={styles.arrowRightIcon3} alt="" src="../arrowright8.svg" />
      ...
      />
      <img className={styles.groupIcon} alt="" src="../group-10000044032.svg" />
    </div>
  );
};
